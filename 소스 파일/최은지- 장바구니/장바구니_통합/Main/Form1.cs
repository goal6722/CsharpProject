    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            try
            {
                ...
                {
                    if (!DBHelperQRcode.IsDBConnected)
                    {
		...
		{
			// 폼 로드 시, DBHelperBarcode 클래스의 GetInventoryData 메서드 호출 예시
			string searchValue = "barcd"; // 원하는 검색 값으로 대체되어야 합니다.
			dbHelper.GetInventoryData(searchValue);
		}
